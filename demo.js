(() => {
  ...
  if (stage === 1) caption('Foco · Pomodoro adaptable');
  if (stage === 2) caption('1 · Organiza tus pequeñas victorias');
  if (stage === 3) {
    document.getElementById('playButton').click();
    document.getElementById('time').textContent = '24:42';
    document.getElementById('playText').textContent = 'pausar';
    caption('2 · Enfócate sin distracciones');
  }
  if (stage >= 4) {
  ...
  if (stage === 4) caption('3 · Mira tu progreso crecer');
  if (stage === 5) {
    document.getElementById('settingsButton').click();
    caption('4 · Encuentra tu propio ritmo');
  }
})();
